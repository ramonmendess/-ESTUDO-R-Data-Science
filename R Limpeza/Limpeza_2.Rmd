...
Limpeza e Tratamento de Dados - 2
(Importação - Edição do nome das colunas - Exploração de dados...das colunas Categóricas e Numéricas - 
Tratamento... Preenchimento de NAs(valores faltantes), Padronização de Dados categóricos, remoção de levels não utilizados,
 Controle de outliers(dados for de domínio))
---
