...
Gráficos Básicos
(Não é necessário importação, Dados inclusos no R - Histograma padrão do R - Leitura de densidade padrão - 
Sobreposição densidade/histograma por parâmetro par(new) - Gráfico de dispersão padrão - Gráfico de 
dispersão tipo linha Padrão - Tremulação (jitter) para diminuir sobreposição em gráfico de dispersão - 
Dispersão categórica com legenda padrão - Gráficos com divisão de tela)
---
Histograma
```{r}
trees
