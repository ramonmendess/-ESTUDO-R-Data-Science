...
(Gráfico de caixa (boxplot) padrão do R - Notch (entalhe no gráfico boxplot) - Vários gráficos - 
Agregação para leitura de gráficos específicos - Gráfico de barra (barplot) - Gráfico de Setor(pie) -
