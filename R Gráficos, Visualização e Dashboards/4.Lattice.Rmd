...
(Utilizar o package lattice - Gráfico de caixa bwplot(lattice) - Histograma histogram(lattice) -
histograma condicional por meio de Agregação - Gráfico de Dispersão Condicional xyplot(lattice) -
Gráfico de Dispersão Categórico dotplot(lattice) - Matriz de Dispersão splom(lattice) - Densidade
Condicional densityplot(lattice) - Gráfico 3D clound(lattice) - Gráfico de nível levelplot(lattice))
---
